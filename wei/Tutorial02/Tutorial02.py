...
if __name__ == '__main__':
    trainpath = '/Users/houjing.wei/Downloads/nlptutorial-master/data/wiki-en-train.word'
    testpath = '/Users/houjing.wei/Downloads/nlptutorial-master/data/wiki-en-test.word'
